...
Bazı Python paketleri (özellikle eski PyTorch sürümü) arm64 wheel'ı yok. Üç seçenek:
...
Bu olmadan `node_modules` and `.venv` her build'de Docker'a kopyalanır → 1-2 GB context, build çok yavaş.
